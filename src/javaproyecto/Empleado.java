...
public class Empleado {
     ...
     */
    public Empleado(int id, String nombre, String apellido1, String apellido2, String nif, String fechaDeNacimiento, String correo, String provincia, String direccion, String genero, int movil) {
        this.id = id;
        this.nombre = nombre;
    ...
    public void agregarNuevoEmpleado()  {
        ...
        try {
            ...
            String query = "insert into empleado (id,nombre,apellido1,apellido2,nif,fechaDeNacimiento,genero,movil,provincia,correo,direccion) values (null,?,?,?,?,?,?,?,?,?,?)";
